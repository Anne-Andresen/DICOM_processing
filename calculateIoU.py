...
for i in range(15, 66):
    ...
    for f in glob.glob('E:/AAU/blob/LN/LN*Slice_00' + str(i) + '*.png'):
        ...
        if int(temp1[3]) == 0 and int(temp1[2]) == 0:
            print('avoid')
        else:
            ...
            print(tempdec20)
            # print(tempjan3)
            boxA46 = [int(tempdec4[2]) - int(dimensions[1]), int(tempdec4[3]) - int(dimensions[1]),
                      int(tempdec4[2]) + int(dimensions[1]), int(tempdec4[3]) + int(dimensions[1])]
            boxB46 = [int(tempdec6[3]) - int(dimensions[1]), int(tempdec6[2]) - int(dimensions[1]),
                      int(tempdec6[3]) + int(dimensions[1]), int(tempdec6[2]) + int(dimensions[1])]
            boxA613 = [int(tempdec6[2]) - int(dimensions[1]), int(tempdec6[3]) - int(dimensions[1]),
                       int(tempdec6[2]) + int(dimensions[1]), int(tempdec6[3]) + int(dimensions[1])]
            boxB613 = [int(tempdec13[2]) - int(dimensions[1]), int(tempdec13[3]) - int(dimensions[1]),
                       int(tempdec13[2]) + int(dimensions[1]), int(tempdec13[3]) + int(dimensions[1])]
            boxA1320 = [int(tempdec13[2]) - int(dimensions[1]), int(tempdec13[3]) - int(dimensions[1]),
                        int(tempdec13[2]) + int(dimensions[1]), int(tempdec13[3]) + int(dimensions[1])]
            boxB1320 = [int(tempdec20[2]) - int(dimensions[1]), int(tempdec20[3]) - int(dimensions[1]),
                        int(tempdec20[2]) + int(dimensions[1]), int(tempdec20[3]) + int(dimensions[1])]
            boxA203 = [int(tempdec20[2]) - int(dimensions[1]), int(tempdec20[3]) - int(dimensions[1]),
                       int(tempdec20[2]) + int(dimensions[1]), int(tempdec20[3]) + int(dimensions[1])]
            boxB203 = [int(tempjan3[2]) - int(dimensions[1]), int(tempjan3[3]) - int(dimensions[1]),
                       int(tempjan3[2]) + int(dimensions[1]), int(tempjan3[3]) + int(dimensions[1])]
            correct46 = bb_intersection_over_union(boxA46, boxB46)
            print('Correct solution - also analytical: {0}\n'
                  .format(correct46))
            if (int(tempdec4[3]) and int(tempdec4[2])) == 0 or (int(tempdec6[3]) and int(tempdec6[2])) == 0:
                print('not appended')
            else:
                total.append(correct46)
                list.append(correct46)
            ...
            print('Correct solution - also analytical: {0}\n'
                  .format(correct613))
            if (int(tempdec6[3]) and int(tempdec6[2])) == 0 or (int(tempdec13[3]) and int(tempdec13[2])) == 0:
                print('not appended')
            else:

                total.append(correct613)
                list.append(correct613)
            print('Normalizing coordinates in a 100x100 coordinate system')
            ...
            print('Correct solution - also analytical: {0}\n'
                  .format(correct1320))
            if (int(tempdec13[3]) and int(tempdec13[2])) == 0 or (int(tempdec20[3]) and int(tempdec20[2])) == 0:
                print('not appended')
            else:
                total.append(correct1320)
                list.append(correct1320)
            ...
            print('Correct solution - also analytical: {0}\n'
                  .format(correct203))
            if (int(tempdec20[3]) and int(tempdec20[2])) == 0 or (int(tempjan3[3]) and int(tempjan3[2])) == 0:
                print('not appended')
            else:
                total.append(correct203)
                list.append(correct203)
            print('Normalizing coordinates in a 100x100 coordinate system')
            ...
            # pris = ' Mean of slice Euclidean distance: ' + str(temp1[0]) + ' ' + str(Dec46)
            file1.write('IoU between 4 to 6: ' + str(temp1[0]) + ' Slice_' + str(temp1[1]) + ' ' + str(correct46))
            file1.write('\n')
            file1.write('IoU between 6 to 13: ' + str(temp1[0]) + ' Slice_' + str(temp1[1]) + ' ' + str(correct613))
            file1.write('\n')
            file1.write('IoU between 13 to 20: ' + str(temp1[0]) + ' Slice_' + str(temp1[1]) + ' ' + str(correct1320))
            file1.write('\n')
            file1.write('IoU between 20 to 3: ' + str(temp1[0]) + ' Slice_' + str(temp1[1]) + ' ' + str(correct203))
            file1.write('\n')
            file1.close()
    Slice_avg = sum(list) / len(list)
    MIN = min(list)
    MAX = max(list)
    file1 = open('IoU_slice_avg.txt', 'a')
    file1.write('\n')
    file1.write('\n')
    file1.write('Mean IoU Slice: ' + str(temp1[1]) + ' ' + str(Slice_avg))
    file1.write('\n')
    file1.write('Min IoU Slice: ' + str(temp1[1]) + ' ' + str(MIN))
    file1.write('\n')
    file1.write('Max IoU Slice: ' + str(temp1[1]) + ' ' + str(MAX))
    file1.write('\n')
    file1.write('\n')
    file1.close()
...
Overall_avg = sum(total) / len(total)
print(Overall_avg)
file1 = open('IoU_slice_avg.txt', 'a')
file1.write('\n')
file1.write('\n')
file1.write('Mean IoU Overall: ' + str(Overall_avg))
file1.write('\n')
file1.write('\n')
file1.close()
